    ...
    <div class="  p-4 rounded">
        ...
        <div class="lead mt-3">
            <form method='post' action='#'>
                Période sélectionnée : {{$period}} <a class='btn btn-success btn-sm ml-2' href="{{ route('transformation::statistiques.index', ['period' =>$period, 'calcul' =>$period] ) }}" id='btnstat' name='btnstat'>Recalculer cette période</a>
            </form>
        </div>
    </div>
    <div class='ms-4'>
