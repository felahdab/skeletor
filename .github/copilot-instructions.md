...
Never run the tests against the skeletordb database. Always use the testdb database for running the tests.
The testmysql and testpgsql database connexions are already configured in the base application.
