<div>
    <div>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane show active" id="nav-table" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0"><livewire:dashboardarchive-table></div>
            @if(! is_null($charts) && sizeof($charts))
                @foreach($charts as $chart)
                    <div class="tab-pane" id="nav-{{ $chart['id'] }}" role="tabpanel" tabindex="0">
                        @if ($chart['id']=="moyenne_globale")
                            <div class="container-fluid mt-3">
                                <div class="row">
                                    <div class="col-lg-6 text-center lead">
