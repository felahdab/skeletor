...
<head>
    ...
    <script src="{{ asset('js/scramble/stoplight_elements_web-components.min.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('css/scramble/stoplight_elements_styles.min.css') }}">
