...
<img src="{{ url(asset('docs/images/' . env('DOC_VERSION') . '/transformation/filtres_fiches_bilan.png' )) }}" width=600px>
...
<img src="{{ url(asset('docs/images/' . env('DOC_VERSION') . '/transformation/liste_fiches_bilan.png' )) }}" width=600px>
