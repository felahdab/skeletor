...
if (! function_exists('cast_as_eloquent_descendant')){
     ...
     * 
     * Par exemple, si dans un module on étend le modèle User de Skeletor parce qu'on souhaite rajouter des relations qui
     * n'existent quand dans le contexte de ce module, on peut utiliser:
     * 
