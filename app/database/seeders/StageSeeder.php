...
class StageSeeder extends Seeder
{
    ...
    public function run()
    {
        $records = [
            [1, 'OO-1', '', 0, 2],
            [2, '12.7MM MAINT', '12,7 mm Browning ', 0, 0],
            [3, '12.7MM MOE', 'Servant de la mitrailleuse de 12,7 mm Browning', 0, 0],
            [4, '20 MM-TO-NARWHAL', 'maintenance et de mise en œuvre 20 mm NARWHAL 20 B', 0, 0],
            [5, '76 MM-1', 'équipier 76 mm', 0, 0],
            [6, '76 MM-2', 'chef d\'équipe de l\'artillerie 76MM', 0, 0],
            [7, 'ACTUNRBC', '', 0, 0],
            [8, 'ADMINLINUX', '', 0, 0],
            ...
            [43, 'EQUINAV-2', '', 0, 0],
            [44, 'EWS-FREMM', '', 0, 0],
            [45, 'EDCH ', 'analyse eau destination conso humaine', 1, 0],
            ...
            [124, 'SN2', 'SN2', 1, 0],
            [125, 'SN3', 'SN3', 1, 0],
            [126, 'CONF CADRE', 'CONFERENCE CADRE', 1, 0],
            [127, 'FCM - SDC/LDT', 'FCM - Module 3.1.2 - SDC/LDT', 0, 0]
        ];
